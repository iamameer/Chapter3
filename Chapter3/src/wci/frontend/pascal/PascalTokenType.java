...
public enum PascalTokenType implements TokenType
{
    ...
    THEN, TO, TYPE, UNTIL, VAR, WHILE, WITH, SWITCH, MACRO,
    ...
    UP_ARROW("^"), DOT_DOT(".."), AND1("&"), AND2("&&"),

    IDENTIFIER, INTEGER, REAL, STRING,
    ERROR, END_OF_FILE;

    private static final int FIRST_RESERVED_INDEX = AND.ordinal();
    private static final int LAST_RESERVED_INDEX  = MACRO.ordinal();

    private static final int FIRST_SPECIAL_INDEX = PLUS.ordinal();
    private static final int LAST_SPECIAL_INDEX  = AND2.ordinal();
